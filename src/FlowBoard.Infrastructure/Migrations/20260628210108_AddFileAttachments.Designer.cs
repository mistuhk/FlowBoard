...
namespace FlowBoard.Infrastructure.Migrations
{
    ...
    [Migration("20260628210108_AddFileAttachments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowBoard.Modules.Tasks.Domain.Aggregates.TaskItem", b =>
                {
                    ...
                    b.HasIndex("OrganisationId", "Priority")
                    ...
                    b.ToTable("tasks", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_tasks_status", "status IN ('todo', 'in_progress', 'blocked', 'done')");

                            t.HasCheckConstraint("chk_tasks_title", "char_length(title) BETWEEN 1 AND 255");
                        });
                });
            ...
            modelBuilder.Entity("FlowBoard.Modules.Tasks.Domain.Aggregates.TaskItem", b =>
                {
                    b.OwnsMany("FlowBoard.Modules.Tasks.Domain.Entities.Attachment", "Attachments", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.ToTable("file_attachments", null, t =>
                                {
                                    t.HasCheckConstraint("chk_file_attachments_size", "file_size_bytes > 0");
                                });

                            b1.WithOwner()
                                .HasForeignKey("TaskId")
                                .HasConstraintName("fk_file_attachments_tasks_task_id");
                        });
